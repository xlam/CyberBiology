...
/**
 * Абстрактный класс, реализующий базовый функционал. Запись ведется в отдельном
 * потоке, поскольку данный очень много пишется не каждый кадр, а каждый
 * frameSkipSize
 *
 * TODO: Можно сделать автоматическую подстройку, увеличивать количество
 * пропускаемых кадров, если буффер заполняется более некоторого значения.
 *
 * @author Nickolay
 */
